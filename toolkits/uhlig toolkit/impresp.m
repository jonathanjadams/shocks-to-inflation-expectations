...
%   SELECT_SHOCKS : choose the shocks to which impulse responses should be plotted.
%                      Default: 1 : k
%   SELECT_STATES : choose the states to which impulse responses should be plotted.  
%                      Default: 1 : m
